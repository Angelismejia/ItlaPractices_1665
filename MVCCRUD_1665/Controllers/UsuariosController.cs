...
using MVCCRUD_1665.Models;

namespace MVCCRUD_1665.Controllers
{
    public class UsuariosController : Controller
    {
        private readonly Mvccrud1665Context _context;

        public UsuariosController(Mvccrud1665Context context)
        {
            _context = context;
        }
